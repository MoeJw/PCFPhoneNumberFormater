...
export class PhoneNumberFormatControlVM {
  ...
  countryCodeOptions: ComponentFramework.PropertyHelper.OptionMetadata[] = [];
    ...
    entityLogicalName: string  | null= null;
    entityLogicalFieldName: string  | null= null;
    id : string|null = null;
  ...
  onLoad(): void {
    ...
    this.phoneNumber = this.controlContext.getParameters<IInputs>().phoneNumber.raw;
      ...
      this.doNotContact = this.controlContext.getParameters<IInputs>().doNotContact.raw;
      this.entityLogicalName = this.controlContext.getParameters<IInputs>().entityLogicalName.raw;
      this.entityLogicalFieldName = this.controlContext.getParameters<IInputs>().entityLogicalFieldName.raw;
      this.id = this.controlContext.getParameters<IInputs>().id.raw;
      ...
      switch (param) {
        ...
        case "countryCode":
          ...
          case "doNotContact":
              ...
              this.doNotContact = args.values[param] as  boolean ;
              break;
          break;
      }
    }
...
decorate(PhoneNumberFormatControlVM, {
  ...
  onPhoneNumberChanged: action.bound,
    ...
    doNotContact: observable,
    entityLogicalName: observable,
    entityLogicalFieldName : observable,
    id :observable
});
